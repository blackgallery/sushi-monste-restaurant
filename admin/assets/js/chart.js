...
$(document).ready(function() {
      ...
      data: {
        ...
        datasets: [
          ...
          },
          {
            ...
            borderColor: "rgba(253, 197, 6, 0)",
            data: [0, 3, 5, 3.8, 5.2, 1.8, 2.2]
          }
        ]
      },
      options: {
  ...
  var doughnut = document.getElementById("salesOverChart");
  if (doughnut !== null) {
    var myDoughnutChart = new Chart(doughnut, {
      type: "doughnut",
      data: {
        ...
        datasets: [
          {
            ...
            data: [46, 27, 27],
            backgroundColor: ["#7366ff", "#1CBB8C", "#F2C839"],
            borderWidth: 1
            // borderColor: ['#4c84ff','#29cc97','#8061ef','#fec402']
            // hoverBorderColor: ['#4c84ff', '#29cc97', '#8061ef', '#fec402']
          }
  ...
  var myChart = new Chart(barX, {
    ...
    data: {
      ...
      datasets: [
        {
          label: "signup",
          data: [5, 6,7, 8, 9, 10, 10, 9, 8, 7, 6, 5],
          // data: [2, 3.2, 1.8, 2.1, 1.5, 3.5, 4, 2.3, 2.9, 4.5, 1.8, 3.4, 2.8],
          backgroundColor: "#4c84ff"
        }
      ]
